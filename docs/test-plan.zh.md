...
**当前状态：** 157 项单元测试全绿，覆盖率 80%/67%/79%/83%
...
**通过标准**：`pnpm test` 输出 `157 passed (157)`，没有红色报错。
...
| 4 | 补 WS 生命周期测试 | 给 AI | ✅ 已完成（7 项） |
| 5 | 补工具层错误路径测试 | 给 AI | ✅ 已完成（6 项） |
| 6 | 补 Telnet 边界测试 | 给 AI | ✅ 已完成（4 项） |
| 7 | 补客户端 ws.ts 测试 | 给 AI | ✅ 已完成（11 项） |
| 8 | 补客户端 store.ts 测试 | 给 AI | ✅ 已完成（19 项） |
