...
.tm-opt { font-size:10px; color:var(--dsw-alias-label-caption, #aaa); border:1px solid var(--dsw-alias-border-l2, rgba(0,0,0,.1)); border-radius:5px; padding:0 4px; margin-left:3px; }
...
.tm-secLabel { font-size:12px; color:var(--dsw-alias-label-secondary, #555); font-weight:600; letter-spacing:.3px; margin-bottom:6px; }
.tm-ritem { display:flex; align-items:center; gap:7px; padding:6px 8px; border-radius:7px; background:var(--dsw-alias-bg-base, #fff); border:1px solid var(--dsw-alias-border-l2, rgba(0,0,0,.1)); font-size:13px; cursor:pointer; margin-bottom:4px; }
.tm-ritem:hover { border-color:var(--dsw-alias-border-l3, rgba(0,0,0,.16)); }
.tm-pico { font-size:10px; font-weight:700; padding:1px 5px; border-radius:4px; font-family:var(--dsw-font-code, monospace); }
...
.tm-sub { display:block; font-size:11px; font-weight:400; color:var(--dsw-alias-label-caption, #aaa); font-family:var(--dsw-font-code, monospace); }
