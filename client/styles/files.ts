...
.tm-fpBar { flex:none; display:flex; align-items:center; gap:8px; padding:5px 12px; cursor:pointer; user-select:none; font-size:12.5px; font-weight:600; color:var(--dsw-alias-label-primary, #000); white-space:nowrap; }
...
.tm-fpBody { display:flex; flex-direction:column; border-top:1px solid var(--dsw-alias-border-l2, rgba(0,0,0,.1)); height:220px; min-height:0; }
.tm-fpToolbar { flex:none; display:flex; align-items:center; gap:6px; padding:5px 10px; flex-wrap:wrap; }
.tm-fpToolbar .hint { color:var(--dsw-alias-label-tertiary, #888); font-size:11px; margin-left:6px; }
.tm-fpPath { flex:none; display:flex; align-items:center; gap:2px; padding:2px 10px 5px; font:11.3px var(--dsw-font-code, monospace); color:var(--dsw-alias-label-tertiary, #888); flex-wrap:wrap; }
